...
const Chat = () => {
  ...
  return (
    <div className="h-screen bg-white flex flex-col overflow-hidden">
      {/* ── Header ── */}
      <div className="border-b border-black/10 px-3 py-2.5 sm:px-4 sm:py-3 flex items-center justify-between gap-2 shrink-0">
        {/* Left: room + user info */}
      ...
      {/* ── Input bar ── */}
      <div className="border-t border-black/10 px-3 py-2.5 sm:px-4 sm:py-3 shrink-0">
